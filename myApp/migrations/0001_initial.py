...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SystemUserModel',
            fields=[
                ('basemodel_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='myApp.basemodel')),
                ('position', models.CharField(choices=[('OPERATOR', 'OPERATOR'), ('ENTREPRENEURS', 'ENTREPRENEURS')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='myApp.systemusermodel')),
            ],
            options={
                'verbose_name': 'order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='myApp.systemusermodel')),
                ('order_information', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='contact', to='myApp.ordermodel')),
            ],
            bases=('myApp.basemodel',),
        ),
    ]
